<%-- 
    Document   : Galery
    Created on : May 31, 2021, 11:30:34 AM
    Author     : DELL
--%>
                            ...
                            <div class="imageGaler">
                                <ul id="slides">
                                    <li class="slide showing">
                                        <img src="images/${top1Galery.imageUrl}" alt="First">
                                    </li>
                                    <c:forEach items="${listImage}" var="i" varStatus="loop">
                                        <li class="slide">
                                            <img src="images/${i.imageUrl}" >${i.viewimage} View
                                        </li>
                                    </c:forEach>
                                </ul>
                            ...
                            <c:if test="${error == null}">
                                <ul>
                                    ...
                                    <c:if test="${index <= maxPage}">
                                        <c:forEach items="${listImage}" var="i" varStatus="loop">
                                            <li class="span4">
                                                <a href="GaLeryServlet?index=${index}&galeryID=${galeryID}&imgID=${i.id}"><img src="images/${i.imageUrl}" >${i.viewimage} View</a>
                                            </li>
                                        </c:forEach>
